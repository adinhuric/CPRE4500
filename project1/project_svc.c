...
date_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case DATE:
		...
		local = (char *(*)(char *, struct svc_req *)) get_date_svc;
		break;

	case MEMORY:
		_xdr_argument = (xdrproc_t) xdr_void;
		_xdr_result = (xdrproc_t) xdr_double;
		local = (char *(*)(char *, struct svc_req *)) get_memory_svc;
		break;

	case PROCESS:
		_xdr_argument = (xdrproc_t) xdr_void;
		_xdr_result = (xdrproc_t) xdr_double;
		local = (char *(*)(char *, struct svc_req *)) get_load_procs_svc;
		break;

	case CPU:
		_xdr_argument = (xdrproc_t) xdr_void;
		_xdr_result = (xdrproc_t) xdr_double;
		local = (char *(*)(char *, struct svc_req *)) get_cpu_svc;
		break;
